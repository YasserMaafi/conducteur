...
if ($origin) {
    $query .= " AND g1.id_gare = ?";
    $params[] = $origin;
}

if ($destination) {
    $query .= " AND g2.id_gare = ?";
    $params[] = $destination;
}
...
<head>
    ...
    <title>Tous les Contrats | SNCFT Agent</title>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-9">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 class="mb-1">Tous les Contrats</h4>
                        <p class="text-muted mb-0">Gérez et suivez tous vos contrats</p>
                    </div>
                    ...
                    <form class="row g-3" method="GET">
                        <div class="col-md-3">
                            ...
                            <select name="status" class="form-select">
                                ...
                                <option value="in-transit" <?= $status === 'in-transit' ? 'selected' : '' ?>>En transit</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="origin" class="form-select">
                                ...
                                <?php foreach ($gares as $gare): ?>
                                    <option value="<?= $gare['id_gare'] ?>" <?= $origin == $gare['id_gare'] ? 'selected' : '' ?>>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="destination" class="form-select">
                                <option value="">Toutes les gares</option>
                                <?php foreach ($gares as $gare): ?>
                                    <option value="<?= $gare['id_gare'] ?>" <?= $destination == $gare['id_gare'] ? 'selected' : '' ?>>
                                        <?= htmlspecialchars($gare['libelle']) ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="col-md-6 d-flex align-items-end">
                            ...
                            <a href="agent-contracts.php" class="btn btn-outline-secondary">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="action-buttons">
                                                        ...
                                                        <?php endif; ?>
                                                        <a href="view-contract.php?id=<?= $contract['contract_id'] ?>" 
