    ...
    <div class="row">
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="card shadow-sm">
          <div class="card-header bg-white"><h6><i class="fas fa-bell me-2"></i>Notifications</h6></div>
          <div class="card-body p-0">
            <?php if (empty($notifications)): ?>
              <div class="p-3 text-center text-muted">Aucune nouvelle notification</div>
            <?php else: ?>
              <?php foreach ($notifications as $n): ?>
                <?php $md = json_decode($n['metadata'] ?? '{}', true);
                      $link = $md['link'] ?? '#';
                      $cls  = $n['is_read'] ? '' : 'unread';
                ?>
                <div class="notification-item <?= $cls ?> px-3 py-2 border-bottom" data-id="<?= $n['id'] ?>">
                  <a href="<?= htmlspecialchars($link) ?>" class="text-dark text-decoration-none">
          ...
          <div class="card-footer text-center">
            <a href="notifications.php" class="btn btn-sm btn-link">Voir toutes</a>
          </div>
        </div>
      </div>
                  ...
                  <tbody>
                    <?php foreach ($active_shipments as $s): ?>
                      <tr>
                        ...
                        <td>
                          <a href="contract_details.php?id=<?= $s['contract_id'] ?>" class="btn btn-sm btn-outline-primary">
                            <i class="fas fa-eye"></i>
                          </a>
