...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_payment'])) {
    try {
        ...
        WHERE c.contract_id = ?
    ");
        $stmt->execute([$payment_method, $payment_date, $payment_reference, $contract_id]);
        ...
        if ($client) {
            ...
            $notificationData = [
                ...
                'amount' => $contract['total_port_due']
            ];
                ...
                <form method="POST">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Numéro de chèque, référence de virement, etc.</small>
                        </div>
