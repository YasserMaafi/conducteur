            ...
            <div class="col-lg-3">
                <div class="sidebar p-3 shadow-sm">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="new-contract.php">
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card stat-card bg-info text-white h-100">
                            <div class="card-body">
                                ...
                                <p class="card-text mt-2 small">
                                    <a href="shipments.php" class="text-white">Voir toutes <i class="fas fa-arrow-right ms-1"></i></a>
                                </p>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <li>
                                                            <a class="dropdown-item" href="view-contract.php?id=<?= $contract['contract_id'] ?>">
                                                        ...
                                                        <?php endif; ?>
                                                        <li>
                                                            <a class="dropdown-item" href="print-contract.php?id=<?= $contract['contract_id'] ?>">
