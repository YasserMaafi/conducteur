...
$stmt = $pdo->prepare("
    SELECT t.*, 
           ...
           COUNT(DISTINCT e.expedition_id) as active_expeditions
    FROM trains t
    LEFT JOIN wagon_assignments wa ON t.train_id = wa.train_id AND wa.status = 'assigned'
    LEFT JOIN expeditions e ON t.train_id = e.train_id AND e.status IN ('pending', 'in_progress')
    $where_clause
    GROUP BY t.train_id
...
<body>
    ...
    <div class="admin-sidebar">
        ...
        <ul class="nav flex-column px-3">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="manage-trains.php">
                    <i class="fas fa-train"></i> Gestion Trains
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="manage-wagons.php">
                    <i class="fas fa-boxes"></i> Gestion Wagons
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="manage-stations.php">
                    <i class="fas fa-map-marker-alt"></i> Gestion Gares
                </a>
            </li>
            <li class="nav-item">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <span class="badge bg-primary">
                                        ...
                                        <?= $train['active_expeditions'] ?> expéditions
                                    </span>
                                </div>
                        ...
                        <div class="modal-content">
                            <form method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <?php if ($train['active_expeditions'] > 0): ?>
                                        <div class="alert alert-danger">
                                            <i class="fas fa-exclamation-circle me-2"></i>
                                            Attention : Ce train a <?= $train['active_expeditions'] ?> expédition(s) active(s).
                                        </div>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-danger" 
                                            <?= $train['active_expeditions'] > 0 ? 'disabled' : '' ?>>
                                        Supprimer
                                    </button>
                                </div>
                            </form>
